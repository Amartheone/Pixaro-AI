...
const PricingCard = ({
  ...
  const isCurrentPlan = id ? has?.({ plan: id }) : false; //This will check if the user has free plan or pro plan
  ...
  return (
    ...
    >
      ...
      <div className="text-center">
        ...
        <div className="text-4xl font-bold bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text bg-transparent mb-6">
          ${price}
        ...
        <ul className="space-y-2 mb-8">
            ...
            <Button variant={isCurrentPlan ? "glass" : "primary"} size="xl" className="w-full"
...
const Pricing = () => {
  const plans = [
    ...
    },
    {
      ...
      featured: true,
      planId: "cplan_30oMVDOl5dVtxQ1dNgv5by1OkJU",
