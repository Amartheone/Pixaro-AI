          ...
          {restrictedTool && (
            <Alert className="bg-amber-500/10 border-amber-500/20">
              ...
              <AlertDescription className="text-amber-300/80">
                ...
                {reason ||
                  `${getToolName(restrictedTool)} is only available on the Pro plan. Upgrade now unlock this powerful feature and more.`}
              </AlertDescription>
            </Alert>
          )}
          ...
          <PricingTable
            checkoutProps={{
              appearance: {
                elements: {
                  drawerRoot: {
                    zIndex: 20000, //to get our pricing table on top of all when clicked on the subscribe button...
                  },
                },
              },
            }}
